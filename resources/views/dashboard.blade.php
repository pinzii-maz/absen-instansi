<x-app-layout>
    ...
    <!-- Main Content -->
    <div class="relative min-h-screen z-10 py-12 px-4 sm:px-6 lg:px-8" style="background: linear-gradient(135deg, #f6f8fc 0%, #e9edf5 100%);">
                            ...
                            <div class="space-y-4" data-aos="fade-up" data-aos-delay="100">
                                <div class="flex flex-wrap gap-4">
                                    <button id="btnAbsenMasuk" 
                                            onclick="checkWifiAndRecord('masuk')"
                                    ...
                                    <button id="btnAbsenPulang"
                                            onclick="checkWifiAndRecord('pulang')"
                                ...
                                <div id="wifiStatus" class="mt-4 bg-white rounded-lg p-4 shadow-md border border-gray-200">
            ...
            <div class="bg-white rounded-xl shadow-xl transform transition-all duration-300 hover:shadow-2xl">
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Basic Information -->
                        <div class="space-y-6">
                            <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 hover:shadow-md transition-all duration-300">
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 hover:shadow-md transition-all duration-300">
                                ...
                                <p class="text-lg font-semibold text-gray-800">{{ ucwords(str_replace('_', ' ', auth()->user()->role)) }}</p>
                            </div>
                            ...
                            @if(auth()->user()->role === 'pelaksana')
                                ...
                                <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 hover:shadow-md transition-all duration-300">
                                    ...
                                    <p class="text-lg font-semibold text-gray-800">{{ auth()->user()->jabatan_fungsional }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    <div id="izinModal" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-8 border w-[480px] shadow-2xl rounded-xl bg-white">
            <div class="absolute top-4 right-4">
                <button onclick="closeIzinModal()" class="text-gray-400 hover:text-gray-600 transition-colors duration-300">
            ...
            <form id="izinForm" class="space-y-6">
                <div>
                    ...
                    <select name="jenis_izin" class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-700 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal_mulai" class="block w-full rounded-lg border focus:border-blue-500 focus:ring-blue-500 border-gray-300 bg-white px-4 py-2.5 text-gray-700">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Selesai</label>
                        <input type="date" name="tanggal_selesai" class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-700 focus:border-blue-500 focus:ring-blue-500">
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Keterangan</label>
                    <textarea name="keterangan" rows="3" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition-all  text-gray-700" placeholder="Tuliskan alasan izin Anda..."></textarea>
                </div>
    ...
    <script>
        ...
        document.getElementById('izinForm').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                showNotification('Pengajuan izin berhasil dikirim!', 'success');
            }, 2000);
        });
