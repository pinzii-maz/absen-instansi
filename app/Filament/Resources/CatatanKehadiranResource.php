...
->toggleable(isToggledHiddenByDefault: true)
        ...
        ActionGroup::make([
            ...
            'approved_by' => auth()->id(), // Simpan siapa yang menyetujui
        ]);

                    $record->user->notify(new LeaveApprovalNotification($record));
            ...
            Action::make('tolak')
                ...
                ->action(function (CatatanKehadiran $record, array $data) {
                    ...
                    $record->user->notify(new LeaveRejectionNotification($record));
